...
class add_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_srvRequest
    let len;
    let data = new add_srvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_srvRequest(null);
    if (msg.A !== undefined) {
      resolved.A = msg.A;
    }
    else {
...
class add_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type add_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type add_srvResponse
    let len;
    let data = new add_srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new add_srvResponse(null);
...
module.exports = {
  Request: add_srvRequest,
  Response: add_srvResponse,
  md5sum() { return '2a5c7a37218262bae4fcfaa1007692aa'; },
  datatype() { return 'hello_demo/add_srv'; }
};
